...
public class HundirlaFlota {
    ...
    public static void genenarbarcos(int logitud) {
        ...
        // System.out.println("Numero x: "+x+" Numero y: "+y+" Orientacion:
        // "+orientacion+" Orientado: "+orientado);
        generarposiciones(x, y, orientado, logitud);
    }

    // COMPROBAMOS SI NO SE JUNTAN POSICIONES ENTRE LOS BARCOS Y GUARDAMOS SUS
    // POSICIONES
    ...
    public static boolean comprobar(int x, int o) {
        ...
        if (ocupadas.contains(pos) == true || ocupadas.contains(pos2) == true || ocupadas.contains(pos3) == true
                || ocupadas.contains(pos4) == true) {
            return true;
        } else {
            return false;
        }
